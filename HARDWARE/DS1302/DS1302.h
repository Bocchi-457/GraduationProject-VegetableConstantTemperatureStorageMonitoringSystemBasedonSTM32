...
//-------------------------------------------------------------------------*
//IO方向设置
#define DS1302_IO_IN()  {GPIOC->CRH&=0xF0FFFFFF;GPIOC->CRH|=0x08000000;}				//低八位引脚的PC11脚定义为输入
#define DS1302_IO_OUT() {GPIOC->CRH&=0xF0FFFFFF;GPIOC->CRH|=0x03000000;}  	   	//低八位引脚的PC11脚定义为输出
//IO操作函数											   
